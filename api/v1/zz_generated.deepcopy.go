...
func (in *LocalSecretDataSource) DeepCopyInto(out *LocalSecretDataSource) {
	*out = *in
	...
	if in.ConfigMap != nil {
		...
		*out = new(LocalSecretDataSourceRef)
		(*in).DeepCopyInto(*out)
	}
	if in.Secret != nil {
...
func (in *LocalSecretDataSource) DeepCopy() *LocalSecretDataSource {
	if in == nil {
		return nil
	}
	out := new(LocalSecretDataSource)
	in.DeepCopyInto(out)
	return out
}
...
func (in *LocalSecretDataSourceRef) DeepCopy() *LocalSecretDataSourceRef {
	if in == nil {
		return nil
	}
	out := new(LocalSecretDataSourceRef)
...
func (in *TokenSecretSpec) DeepCopyInto(out *TokenSecretSpec) {
	*out = *in
	...
	if in.ExtraData != nil {
		in, out := &in.ExtraData, &out.ExtraData
		*out = make([]LocalSecretDataSource, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
